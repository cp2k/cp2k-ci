...
DEFAULT_ARGS=""
DEFAULT_ARGS="${DEFAULT_ARGS} --cluster="${CLUSTER_NAME}""
DEFAULT_ARGS="${DEFAULT_ARGS} --disk-type=pd-ssd"
DEFAULT_ARGS="${DEFAULT_ARGS} --spot"
DEFAULT_ARGS="${DEFAULT_ARGS} --node-locations="${NODE_LOCATIONS}""
DEFAULT_ARGS="${DEFAULT_ARGS} --location-policy=ANY"
DEFAULT_ARGS="${DEFAULT_ARGS} --enable-autoupgrade"
DEFAULT_ARGS="${DEFAULT_ARGS} --enable-autorepair"
DEFAULT_ARGS="${DEFAULT_ARGS} --enable-autoscaling"
DEFAULT_ARGS="${DEFAULT_ARGS} --total-max-nodes=1"
DEFAULT_ARGS="${DEFAULT_ARGS} --total-min-nodes=0"
DEFAULT_ARGS="${DEFAULT_ARGS} --num-nodes=0"
DEFAULT_ARGS="${DEFAULT_ARGS} --node-taints="costly=true:NoSchedule""
